...
@IonicPage()
@Component({
  selector: 'page-play-search',
  templateUrl: 'play-search.html',
})
export class PlaySearchPage {
  ...
  constructor(
    ...
    console.log(this.beat_files, 'beat_files');
  }
  ...
  onTrackFinished(track: any) {
    this.currentIndex = 0;
    let tracks = this.playlist[0];
    this.selected_track = tracks;
